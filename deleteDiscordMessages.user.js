...
// @match           https://*.discord.com/login// ==UserScript==
// @name            Undiscord
// @description     Delete all messages in a Discord channel or DM (Bulk deletion)
// @version         5.2.4
// @author          victornpb
...
(function () {
	...
	var themeCss = (`
/* PREMIUM GLASSMORPHISM THEME - HIGH CONTRAST */
#undiscord {
  --blurple: #5865F2;
  --danger: #ED4245;
  --success: #3BA55C;
  --glass-bg: #1a1b1e; /* Solid dark fallback */
  --glass-bg-rgba: rgba(0, 0, 0, 0.95); /* Nearly solid for readability */
...
/* undiscord window */
#undiscord.browser { box-shadow: var(--glass-shadow) !important; border: 1px solid var(--glass-border) !important; overflow: hidden; background-color: var(--glass-bg) !important; background-color: var(--glass-bg-rgba) !important; backdrop-filter: blur(16px) !important; border-radius: 12px !important; }
#undiscord.container,
...
#undiscord .header { background: linear-gradient(90deg, rgba(88,101,242,0.3), transparent) !important; border-bottom: 1px solid var(--glass-border) !important; height: 60px !important; align-items: center; min-height: 60px !important; padding: 0 16px; display: flex; color: var(--text-primary) !important; cursor: grab; }
#undiscord .header .icon { color: var(--blurple) !important; margin-right: 8px; flex-shrink: 0; width: 24; height: 24; }
#undiscord .header .icon:hover { color: #fff !important; }
#undiscord .header h3 { font-size: 16px; line-height: 20px; font-weight: 700 !important; font-family: var(--font-display) !important; color: #fff !important; flex-shrink: 0; margin-right: 16px; }
...
#undiscord legend,
#undiscord label { color: var(--text-secondary) !important; font-size: 12px; line-height: 16px; font-weight: 600 !important; text-transform: uppercase; cursor: default; font-family: var(--font-display) !important; margin-bottom: 8px; }
#undiscord .multiInput { display: flex; align-items: center; font-size: 16px; box-sizing: border-box; width: 100%; border-radius: 6px !important; color: #fff !important; background-color: var(--input-bg) !important; border: 1px solid var(--glass-border) !important; transition: border-color 0.2s ease-in-out 0s; }
#undiscord .multiInput :first-child { flex-grow: 1; }
#undiscord .multiInput button:last-child { margin-right: 4px; }
#undiscord .input { font-size: 16px; width: 100%; transition: border-color 0.2s ease-in-out 0s; padding: 10px; height: 44px; background-color: var(--input-bg) !important; border: 1px solid var(--glass-border) !important; border-radius: 6px !important; box-sizing: border-box; color: #fff !important; }
#undiscord fieldset { margin-top: 16px; border: none; }
#undiscord .input-wrapper { display: flex; align-items: center; font-size: 16px; box-sizing: border-box; width: 100%; border-radius: 6px !important; color: #fff !important; background-color: var(--input-bg) !important; border: 1px solid var(--glass-border) !important; transition: border-color 0.2s ease-in-out 0s; }
...
#undiscord input:focus, #undiscord .input-wrapper:focus-within, #undiscord .multiInput:focus-within { border-color: var(--blurple) !important; box-shadow: 0 0 0 1px var(--blurple) !important; }
#undiscord .divider,
...
#undiscord a { color: #00AFF4 !important; text-decoration: none; }
#undiscord .btn,
#undiscord button { position: relative; display: flex; -webkit-box-pack: center; justify-content: center; -webkit-box-align: center; align-items: center; box-sizing: border-box; background: none; border: 1px solid var(--glass-border) !important; border-radius: 4px !important; font-size: 14px; font-weight: 600 !important; line-height: 16px; padding: 2px 16px; user-select: none; /* sizeSmall */     width: 60px; height: 32px; min-width: 60px; min-height: 32px; /* lookFilled colorPrimary */     color: rgb(255, 255, 255); background-color: var(--blurple) !important; transition: all 0.2s; opacity: 1; }
#undiscord button:hover { background-color: var(--blurple-hover) !important; transform: translateY(-1px); }
...
#undiscord .accent { background-color: var(--blurple) !important; border: none !important; }
#undiscord .accent:hover { background-color: #4752C4 !important; }
#undiscord .danger { background-color: var(--danger) !important; border: none !important; }
#undiscord .danger:hover { background-color: #d83c3e !important; }
#undiscord .positive { background-color: var(--success) !important; }
